  ...
  <el-card :class="[$attrs.class, isEditMode ? 'isEditMode' : '']">
    <div class="form-container">
      ...
      <div class="form-buttons">
        <el-button v-if="isEditMode" @click="processAction('delete')" type="danger" :icon="iconDelete" round>
          Удалить
        </el-button>
...
.el-card.light .form-container .el-form-item.is-required:not(.is-no-asterisk).asterisk-left>:deep(.el-form-item__label:before),
